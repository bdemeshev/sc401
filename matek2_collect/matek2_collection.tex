...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Find $h(\alpha) = \E(-\alpha \tau)$ for arbitrary $\alpha$.
...
\item 6a: 8 points:
martingale equation = 1 point, 
simplify this equation of obtain equation for $f(\lambda)$ and $\E\exp(\lambda Z_t)$ = 3 points,
correct expected value of $\E\exp(\lambda Z_t)$ = 3 points,
solution for $f(\lambda)$ = 1 point (provided the equation is correct)

6b: 5 points 
2 points for unique equation 
3 points for the second equation

6c: 2 points (provided equations are correct)
