...
Office: $if(office)$$office$$else$TBD$endif$  & Web: $if(web)$\href{http://$web$}{\tt $web$}$else$TBD$endif$\\
Office Hours: $if(officehours)$$officehours$$else$TBD$endif$  &  E-mail: $if(email)$\texttt{$email$}$else$TBD$endif$\\
	\hline
	\end{tabular*}
